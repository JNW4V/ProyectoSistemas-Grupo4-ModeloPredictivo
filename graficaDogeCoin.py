...
def mostrar_grafico_dogeCoin():
    ...
    # Graficar los datos de precios de cierre con fondo de cuadrícula
    plt.figure(figsize=(12, 6))
    plt.plot(df['timestamp'], df['close'], label='Precio DOGE', color='blue')
    ...
    plt.title('Gráfico de precios de DOGE/USDT (Últimas 24 horas)')
    plt.xticks(rotation=45)

    # Mostrar leyenda
    plt.legend()

    # Ajustar la disposición para que no se superpongan las etiquetas
    plt.tight_layout()
